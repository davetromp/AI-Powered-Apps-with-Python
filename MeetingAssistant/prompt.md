# meeting assistant
Create a meeting assistant that can record a meeting or upload an audio file of a meeting, will transcibe and then summarize.

Build this using the following stack:
* python
